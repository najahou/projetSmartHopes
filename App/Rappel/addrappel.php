...
session_start();
$rappel_service = new rappel_service();
$rappel = new rappel();

$patient = $rappel_service-> findall2();
$med = $rappel_service-> findall1();
if ($_SERVER["REQUEST_METHOD"] == "POST") {

    $rappel= $rappel->getrappel1($_POST["heur"],$_POST["nbheur"],$_POST["id_medicament"],$_POST["idp"]);
     var_dump($rappel);
    if($rappel_service->add($rappel)){
        echo header('Location: addrappel.php?added=ok');
    }
    else{
        echo header('Location: addrappel.php?added=non');
    }
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="app">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item" hidden><a class="nav-link" href="updatepharmacie.php">Liste Pharmacie</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="elements">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item" hidden><a class="nav-link" href="../patient/updatepatient.php">Liste Patient</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="charts1">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="addrappel.php">Ajouter Rappel</a></li>
                            <li class="nav-item"> <a class="nav-link" href="listerappel.php">Liste Rappel</a></li>
                ...
                <div class="container-fluid">
                    <?php if(isset($_GET["added"])){
                        if($_GET["added"] == "ok"){?>
                            <div id="succes" class="alert alert-success" role="alert">
                                <strong>Success - </strong> Rappel Bien Ajouter
                            </div>
                            <?php
                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" align="center">Ajouter Rappel</h4>
                                    <form class="forms-sample" action="addrappel.php" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Heure de prise  :<small>Veuillez Separer les heures par des virgules</small></label>
                                            <input type="text"  name="heur" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nombre de fois</label>
                                            <input type="text"  name="nbheur" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Patient:</label>

                                        <input type="text"  name="idp" class="form-control" list="pharmacie-name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="id_medicament" class="form-control" list="medic-name">
                                            <datalist id="medic-name">
                                                <?php foreach ($med as $item){ ?>
                                                    <option value="<?php echo $item['id_medic']?>"> <?php echo $item['nom_medicament']?></option>
                                                <?php } ?>
                                            </datalist>
                                        </div>
