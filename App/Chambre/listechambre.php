                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2" align="center">Liste Chambre</h4>
                                    ...
                                    <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                        ...
                                        <tbody>
                                        <?php foreach ($chambre as $item){ ?>
                                            <tr>
                                                <td><?php echo $item["id_ch"]?></td>
                                                <td><?php echo $item["etage"]?></td>
                                                <td><?php echo $item["nb_lit"] ?></td>
                                                <td><?php echo $item["num_chambre"]?></td>

                                                <td><a href='updatechambre.php?id=<?php echo $item['id_ch'] ?>'>Modifier<i class='fas fa-pencil-alt ms-text-primary'></i></a> <a href='deletechambre.php?id=<?php echo $item['id_ch'] ?>'>Supprimer<i class='far fa-trash-alt ms-text-danger'></i></a></td>
