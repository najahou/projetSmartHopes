                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                        ...
                                        <tr>
                                            <td><?php echo $item["code_pharmacie"] ?></td>
                                            <td><?php echo $item["nompharmacie"]?></td>
                                            <td><?php echo $item["location"]?></td>
                                            <td><?php echo $item["email"]?></td>
                                            <td><?php echo $item["telephone"]?></td>
                                            <td><a href='updatepharmacie.php?id=<?php echo $item['code_pharmacie'] ?>'>Modifier<i class='fas fa-pencil-alt ms-text-primary'></i></a></td>
                                            <td><a href='deletepharmacie.php?id=<?php echo $item['code_pharmacie'] ?>'>Supprimer<i class='far fa-trash-alt ms-text-danger'></i></a></td>
