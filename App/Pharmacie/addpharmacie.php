...
$pharmacie = $pharmacie->construct1($codepharmacie,$email,$location,$nompharmacie,$telephone);
if($Pharmacieservice->add($pharmacie)){
        echo header('Location: addpharmacie.php?added=ok');
    }
    else{
        echo header('Location: addpharmacie.php?added=non');
    }
                    ...
                    <?php if(isset($_GET["added"])){
                        if($_GET["added"] == "ok"){?>
                            <div id="succes" class="alert alert-success" role="alert">
                                <strong>Success - </strong> Pharmacie Bien Ajouter
                            </div>
                            <?php
                        }
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="addpharmacie.php" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Code Pharmacie :</label>
                                            <input type="text" name="codepharmacie" class="form-control" placeholder="Code Pharmacie....">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nom de la Pharmacie :</label>
                                            <input type="text" name="nompharmacie" class="form-control" placeholder="Nom Pharmacie....">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Adresse Pharmacie :</label>
