...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $chambre = $chambre->construct1(htmlentities($_POST["post1"]),htmlentities($_POST["post2"]),htmlentities($_POST["post3"]));
    if($chambres->add($chambre)){
        echo header('Location: addchambre.php?added=ok');
    }
    else{
        echo header('Location: addchambre.php?added=non');
    }
}
?>
<!doctype html>
            ...
            <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div id="succes" class="alert alert-success" role="alert">
                        <strong>Success - </strong> Chambre Bien Ajouter
                    </div>
                    <?php
                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" align="center">Ajouter Chambre</h4>
                                    <form class="forms-sample" action="addchambre.php" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Etage :</label>
                                            <input type="number" name="post1" class="form-control" placeholder="Entrer l'étage">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nombre de lit :</label>
                                            <input type="number" name="post2" class="form-control" placeholder="Entrer le nombre de lit">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Numero de chambre :</label>
                                            <input type="number"  name="post3" class="form-control" placeholder="Entrer la numero de la chambre">
                                        </div>
