                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2" align="center">Liste Besoin</h4>
                                    ...
                                    <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                        ...
                                        <tbody>
                                        <?php foreach ($besoin as $item){ ?>
                                            <tr>
                                                <td><?php echo $item["id_demande"]?></td>
                                                <td><?php echo $item["msg_vocale"]?></td>
                                                <td><a href='afficherdemande.php?id=<?php echo $item['id_demande'] ?>'>Afficher Demande<i class='far fa-trash-alt ms-text-danger'></i></a></td>
