...
if(isset($_GET["id"])){
    $medicament = $medicservice->findbyid($_GET["id"]);

}
if($_SERVER["REQUEST_METHOD"] == "POST"){

    $medicament = $medicament->construct0($_GET['id'],$_POST["post1"],$_POST["post2"],$_POST["post3"],$_POST["post4"],$_POST["post7"],$_POST["post5"]);
    $medicservice->update($medicament);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="updatemedicament.php?id=<?php echo $_GET['id']?>" method="post">

                                        <div class="form-group">
                                            <label class="form-label">Reference :</label>
                                            <input type="text" value="<?php echo $medicament->getReference() ?>" name="post1" class="form-control" placeholder="Entrer Reference">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nom Medicament :</label>
                                            <input type="text" value="<?php echo $medicament->getNomMedicament() ?>" name="post2" class="form-control" placeholder="Entrer Nom Medicament">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label"> ContreIndication:</label>

                                            <textarea rows="3" value="<?php echo $medicament->getContreIndication() ?>" name="post4" class="form-control" placeholder="Entrer ContreIndication" ></textarea>

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Effects :</label>

                                            <textarea rows="3" value="<?php echo $medicament->getEffects() ?>" name="post3" class="form-control" placeholder="Entrer Effects" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Quantite :</label>
                                            <input type="number" value="<?php echo $medicament->getQuantite() ?>" name="post7" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">PharmacieId :</label>
                                            <input type="text" value="<?php echo $medicament->getPharmacieId() ?>" list="pharmacie-name" name="post5" class="form-control" placeholder="Entrer Pharmacie Id" autocomplete="off">
