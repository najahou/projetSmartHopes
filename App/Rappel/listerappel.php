...
session_start();
$Pharmacieservice = new rappel_service();
$pharmacies = $Pharmacieservice->findallrappel();
                                    ...
                                    <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                        ...
                                        <?php foreach ($pharmacies as $item){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $item["heur"] ?></td>
                                                <td><?php echo $item["nb_fois"]?></td>
                                                <td><?php echo $item["medicament_id"]?></td>
                                                <td><?php echo $name = $Pharmacieservice->findbyidgetname($item['patient_id']) ?></td>

                                                <td><a href='deleterappel.php?id=<?php echo $item['id'] ?>'>Supprimer<i class='far fa-trash-alt ms-text-danger'></i></a></td>
