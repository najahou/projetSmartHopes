...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $patient = $patient->construct1($_POST["post1"],$_POST["post2"],$_POST["post3"],$_POST["post4"],$_POST["post5"]
        ,$_POST["post6"],$_POST["post7"],$_POST["post8"],$_POST["post9"],$_POST["post10"],$image,$_POST["post12"]);
    if($patientS->add($patient)){
        echo header('Location: addpatient.php?added=ok');
    }
    else{
        echo header('Location: addpatient.php?added=non');
    }
}
?>
<!doctype html>
                ...
                <div class="container-fluid">
                    <?php if(isset($_GET["added"])){
                        if($_GET["added"] == "ok"){?>
                            <div id="succes" class="alert alert-success" role="alert">
                                <strong>Success - </strong> Patient Bien Ajouter
                            </div>
                            <?php
                        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" align="center">Ajouter Patient</h4>
                                    <form class="forms-sample" action="addpatient.php"  enctype="multipart/form-data" method="post">
                                        <div class="form-group">
                                            <label class="form-label">CIN:</label>
                                            <input type="text" name="post3" class="form-control" placeholder="Enter cin">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nom:</label>
                                            <input type="name" name="post1" class="form-control" placeholder="Enter Nom">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Prenom:</label>
                                            <input type="text" name="post2" class="form-control" placeholder="Enter Prenom">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Date de naissance:</label>
                                            <input type="date" name="post4" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Genre:</label>

                                            <select name="post5" class="form-control">
                                                <option disabled>-Veuillez saisir une valeur-</option>
                                                <option>Male</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="post7" class="form-control" placeholder="Enter adresse">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Num Dossier</label>
                                            <input type="text" name="post8" class="form-control" placeholder="Numero dossier">
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Ville</label>
                                            <input type="text" name="post9" class="form-control" placeholder="La ville">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Id Securité</label>
                                            <input type="text" name="post10" class="form-control" placeholder="Id Securite">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="post12" class="form-control" placeholder="ID Chambre">

                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Telephone:</label>
                                            <input type="tel" name="post6" class="form-control" placeholder="Numero telephone">
