                                    ...
                                    <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                        ...
                                        <?php foreach ($patient as $item){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo  $item["chambre_id"] ?></td>


                                                <td><a href='updatepatient.php?id=<?php echo $item['id'] ?>'>Modifier<i class='fas fa-pencil-alt ms-text-primary'></i></a></td>
                                                <td><a href='deletepatient.php?id=<?php echo $item['id'] ?>'>Supprimer<i class='far fa-trash-alt ms-text-danger'></i></a></td>
