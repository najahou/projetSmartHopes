...
$besoin=$BesoinService->findbyId($_GET["id"]);

$patient = $BesoinService ->findallpatient();
$name = $BesoinService->findbyidgetname($besoin[5]);
$photo = $BesoinService->findbyidgeimage($besoin[5]);

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    echo header('Location: deleteBesoin.php?id='.$_GET["id"]);
}
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="listBesoin.php">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" align="center">Besoin</h4>
                                    <form class="forms-sample" action="afficherdemande.php?id=<?php echo $_GET["id"]?>" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Capture:</label>
                                            <img src="../patient/<?php echo $photo?>" width="20%" height="50%" name="image">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Message vocal Ecrit:</label>
                                            <textarea disabled class="form-control" name="msg_vocale" placeholder="Exprimez-vous"><?php echo $besoin[3]?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">ID Patient:</label>
                                            <input disabled type="text" name="patientid" value="<?php echo $name ?>" name="post3" class="form-control" autocomplete="on">

                                        </div>
                                        <div align="center"> <button type="submit" class="btn btn-primary mr-2">Traiter</button>
