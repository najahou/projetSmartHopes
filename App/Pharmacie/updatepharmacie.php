...
if(isset($_GET["id"])){
    $pharmacie = $Pharmacieservice->findbyid($_GET["id"]);
}
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $pharmacie = $pharmacie->construct1($_GET["id"],$email,$location,$nompharmacie,$telephone);
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="app">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="addpharmacie.php">Ajouter Pharmacie</a></li>
                            <li class="nav-item"><a class="nav-link" href="listepharmacie.php">Liste Pharmacie</a></li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="updatepharmacie.php?id=<?php echo $_GET['id'] ?>" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Code:</label>
                                            <input type="text" value="<?php echo $pharmacie->getCodePharmacie() ?>" name="codepharmacie" class="form-control" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nom:</label>
                                            <input type="text" name="nompharmacie" class="form-control" value="<?php echo $pharmacie->getNompharmacie() ?>">

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Location</label>
                                            <input type="text" class="form-control" placeholder="Enter the Location" value="<?php echo $pharmacie->getLocation()?>" name="location">
                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Telephone:</label>
                                            <input type="tel" value="<?php echo $pharmacie->getTelephone() ?>" name="telephone" class="form-control" placeholder="Enter full number">

                                        </div>

                                        <div class="form-group">
                                            <label class="form-label">Email:</label>
                                            <input type="email" value="<?php echo $pharmacie->getEmail() ?>" name="email" class="form-control" placeholder="Enter full name">
                                        </div>
