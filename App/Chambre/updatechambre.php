...
if(isset($_GET["id"])){
    $chambre = $chambres->findbyid($_GET["id"]);
}
if($_SERVER["REQUEST_METHOD"] == "POST"){

    $chambre = $chambre->construct0($_GET['id'],$_POST["post1"],$_POST["post2"],$_POST["post3"]);
    $chambres->update($chambre);
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="job">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="addchambre.php">Ajouter Chambre</a></li>
                            <li class="nav-item"><a class="nav-link" href="listechambre.php">Liste Chambre</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" align="center">Modifier Chambre</h4>
                                    <form class="forms-sample" action="updatechambre.php?id=<?php echo $_GET['id']?>" method="post">
                                        <div class="form-group">
                                            <label class="form-label">Etage :</label>
                                            <input type="number" value="<?php echo $chambre->getEtage() ?>" name="post1" class="form-control" placeholder="Enter full name">
                                            <small class="form-text text-muted">Enter the full Code</small>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Nombre de lit :</label>
                                            <input type="number" value="<?php echo $chambre->getNbLit() ?>" name="post2" class="form-control" placeholder="Enter email">
                                            <small class="form-text text-muted">Enter the name</small>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Numero de la  chambre :</label>
                                            <input type="number" value="<?php echo $chambre->getNumChambre() ?>" name="post3" class="form-control" placeholder="Enter the Location">
                                        </div>
